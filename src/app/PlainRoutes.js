...
const manifest = {
  3: (state) => (state) => ({...state, videos: undefined}),
  8: (state) => (state) => ({...state, assessment: undefined}),
  11: (state) => (state) => ({...state, navigation: undefined}),
  12: (state) => (state) => ({...state, navigation: undefined})
};
